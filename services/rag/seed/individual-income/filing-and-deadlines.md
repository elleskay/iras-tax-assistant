...
- Individuals are generally required to file if they receive a filing
...
## Officer notes
- A common query is "do I need to file if I only had employment income?". The
  answer depends on whether they received a filing notice or are on NFS, and
  whether they want to claim extra reliefs. Draft the reply with those conditions,
  do not give an unqualified yes/no.
